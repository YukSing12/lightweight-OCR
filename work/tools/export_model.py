...
from export_pruned_model import get_size
...
def main():
    ...
    if config['Architecture']['algorithm'] == "SRN":
        ...
        input_shape = config['Train']['dataset']['transforms'][2]['SRNRecResizeImg']['image_shape']
        other_shape = [
            paddle.static.InputSpec(
                shape=[None, 1, 64, 256], dtype='float32'), [
                    ...
                    paddle.static.InputSpec(
                        shape=[None, num_heads, max_text_length, max_text_length],
                        dtype="int64"), paddle.static.InputSpec(
                            shape=[None, num_heads, max_text_length, max_text_length],
                            dtype="int64")
                ]
    ...
    logger.info('inference model size is {}MB'.format(model_size/1024/1024))
